...
*/
  ...
  const MODULE_CONTENT_TESTIMONIALS_WRITE_NICKNAME = 'Uw Naam';
  const MODULE_CONTENT_TESTIMONIALS_WRITE_NICKNAME_PLACEHOLDER = 'Uw naam (of bijnaam)';
  const MODULE_CONTENT_TESTIMONIALS_WRITE_TEXT = 'Aanbeveling';
  const MODULE_CONTENT_TESTIMONIALS_WRITE_TEXT_PLACEHOLDER = 'Wat zou u wlillen schrijven?';
  const MODULE_CONTENT_TESTIMONIALS_WRITE_BUTTON_TEXT_SEND = 'Verzonden naar Winkeleigenaar';

  const MODULE_CONTENT_TESTIMONIALS_WRITE_THANK_YOU = 'Dank u wel %s, Uw aanbeveling is verzonden naar de Winkeleigenaar.';
