...
*/
  ...
  const MODULE_CONTENT_GDPR_TESTIMONIALS_TITLE = 'GDPR Recensies';
  const MODULE_CONTENT_GDPR_TESTIMONIALS_DESCRIPTION = 'Deze module toont het aantal recensies van de klant..';

  const MODULE_CONTENT_GDPR_TESTIMONIALS_PUBLIC_TITLE = 'Recensies';
  const MODULE_CONTENT_GDPR_TESTIMONIALS_NUM_TESTIMONIALS = 'U heeft<br><span class="h1"><span class="num_testimonials">%s</span></span><br>recensies geschreven';
