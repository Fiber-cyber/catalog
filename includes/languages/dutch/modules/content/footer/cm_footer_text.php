...
*/
 const MODULE_CONTENT_FOOTER_TEXT_TITLE = 'Tekst Blok';
 const MODULE_CONTENT_FOOTER_TEXT_DESCRIPTION = 'Voeg een tekst blok toe aan de footer van je shop';

 const MODULE_CONTENT_FOOTER_TEXT_HEADING_TITLE = 'Over ons';
