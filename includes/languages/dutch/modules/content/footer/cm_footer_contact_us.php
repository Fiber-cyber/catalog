...
*/
const MODULE_CONTENT_FOOTER_CONTACT_US_TITLE = 'Contact Ons Details';
const MODULE_CONTENT_FOOTER_CONTACT_US_DESCRIPTION = 'Voeg een Contact ons toe aan de Footer van je shop';
