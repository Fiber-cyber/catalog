...
const MODULE_NAVBAR_SHOPPING_CART_CONTENTS = '<i title="Winkelwagen" class="fas fa-shopping-cart fa-fw"></i><span class="d-inline d-sm-none d-md-inline"> <span class="cart-count">%1$s</span> artikel(en)</span> <span class="caret"></span>';
...
const MODULE_NAVBAR_SHOPPING_CART_VIEW_CART = 'Bekijk de winkelwagen';
