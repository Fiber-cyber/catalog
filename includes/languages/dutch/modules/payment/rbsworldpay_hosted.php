...
*/
  ...
  define('MODULE_PAYMENT_RBSWORLDPAY_HOSTED_TEXT_WARNING_DEMO_MODE', 'Transactie uitgevoerd in testmodus.');

  define('MODULE_PAYMENT_RBSWORLDPAY_HOSTED_TEXT_SUCCESSFUL_TRANSACTION', 'De betaling is succesvol uitgevoerd! U wordt binnen 3 seconden automatisch teruggeleid naar onze website.');
  define('MODULE_PAYMENT_RBSWORLDPAY_HOSTED_TEXT_CONTINUE_BUTTON', 'Doorgaan met %s');
?>
