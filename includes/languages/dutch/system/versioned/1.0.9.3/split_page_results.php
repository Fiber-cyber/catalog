...
const PREVNEXT_TITLE_PREV_SET_OF_NO_PAGE = 'Vorige set van% d pagina\'s';
const PREVNEXT_TITLE_NEXT_SET_OF_NO_PAGE = 'Volgende set van% d pagina\'s';
...
const TEXT_DESCENDINGLY = 'Sorteer artikelen aflopend op %s';
const TEXT_ASCENDINGLY = 'Sorteer artikelen oplopend op %s';
