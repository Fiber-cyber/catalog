...
const ENTRY_REVIEW_TEXT = '<span class="text-danger fw-bold">NOTE:</span> HTML wordt niet vertaald!';
...
const TEXT_GOOD = '<span class="text-success fw-bold">GOED</span>';
const TEXT_BAD = '<span class="text-danger fw-bold">SLECHT</span>';
