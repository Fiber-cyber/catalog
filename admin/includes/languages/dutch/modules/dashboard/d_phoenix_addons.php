...
define('MODULE_ADMIN_DASHBOARD_PHOENIX_ADDONS_RATING', 'Beoordeling');

define('MODULE_ADMIN_DASHBOARD_PHOENIX_JOIN_CLUB', 'Word lid van de club');
define('MODULE_ADMIN_DASHBOARD_PHOENIX_VIEW_ALL', 'Bekijk de volledige lijst');
