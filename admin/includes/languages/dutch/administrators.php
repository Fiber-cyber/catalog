...
<p>Deze installatie van de Phoenix Beheerders Tool is <strong>niet</strong> extra beveiligd via htaccess / htpasswd.</p>
...
<strong>Extra bescherming met htaccess / htpasswd</strong>
<p>Deze Phoenix Beheerders Tool-installatie is beveiligd via htaccess / htpasswd-middelen.</p>
EOT;
const HTPASSWD_PERMISSIONS = <<<'EOT'
<strong>Extra bescherming met htaccess / htpasswd</strong>
<p>Deze installatie van de Phoenix Administration Tool is niet extra beveiligd via htaccess / htpasswd.</p>
